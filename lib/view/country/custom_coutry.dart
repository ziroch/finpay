// ignore_for_file: unnecessary_new, prefer_equal_for_default_values, unnecessary_const, empty_catches, unnecessary_string_interpolations, library_private_types_in_public_api, deprecated_colon_for_default_value, deprecated_member_use

import 'dart:convert';

import 'package:finpay/config/images.dart';
import 'package:finpay/config/textstyle.dart';
import 'package:finpay/view/reason/select_reason_screen.dart';
...
Future<Country?> showCountryPickerDialog(
  ...
  return showDialog<Country?>(
      context: context,
      barrierColor: AppTheme.isLightTheme == false
...
class _CountryPickerWidgetState extends State<CountryPickerWidget> {
  ...
  void loadList() async {
    ...
    try {
      ...
      _currentCountry =
          _list.firstWhere((element) => element.countryCode == "ir");
